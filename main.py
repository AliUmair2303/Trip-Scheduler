...
""".strip()
def submit():
    prompt = "I want to get flight details "
...
with st.form(key="trip_form"):
    ...
    with c1:
        ...
        origin = st.text_input(
            "Destination", value=random_destination, key="destination"
        )
    ...
    with c2:
        ...
        st.date_input(
            "Departure Date", value=now_date + timedelta(days=1), key="departure_date"
        )
